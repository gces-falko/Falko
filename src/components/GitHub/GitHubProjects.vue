            ...
            <div class="col" v-if="userRepos.length != 0">
              ...
              <div class="collapse" id="userReposCollapse">
                <div class="scroll-style-github-projects">
                  <ul class="list-group">
                    <li class="list-group-item" v-for="userRepo in userRepos" :key="userRepo">
                      {{userRepo}}
            ...
            <div class="col" v-else>
              <div v-if="userRepos.length != 0">
                ...
                <div class="collapse" v-bind:id="orgs.name">
                  <div class="scroll-style-github-projects">
                    <ul class="list-group">
                      <li class="list-group-item" v-for="repo in orgs.repos" :key="repo">
                        {{repo}}
              ...
              <div v-if="orgsRepos.length != 0">
                <div v-for="orgs in orgsRepos" :key="orgs">
                  <h4
                  data-toggle="collapse"
                  class="pointer-cursor dropdown-toggle"
                  ...
                  <div class="collapse" v-bind:id="orgs.name">
                    <ul class="list-group">
                      <li class="list-group-item" v-for="repo in orgsRepos.repos" :key="repo">
                        {{repo}}
