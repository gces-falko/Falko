              ...
              <div class="row">
                <p class="col-md-4">
                  <ul class="list-group ">
                    ...
                    <li v-for="(positive, index) in positivePoints" class="list-group-item" :key="positive-points">
                      <h6> • {{positive}}</h6>
                    </li>
                  </ul>
                </p>
                ...
                <p class="col-md-4">
                  <ul class="list-group">
                    ...
                    <li v-for="(negative, index) in negativePoints" class="list-group-item" :key="negative-points">
                      <h6>• {{negative}}</h6>
                    </li>
                  </ul>
                </p>
                ...
                <p class="col-md-4">
                  <ul class="list-group">
                    ...
                    <li v-for="(improvement, index) in improvements" class="list-group-item" :key="improvement">
                      <h6>• {{improvement}}</h6>
                    </li>
                  </ul>
                </p>
