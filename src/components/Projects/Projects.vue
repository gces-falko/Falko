<template>
  <div>
    ...
    <div class="row justify-content-around" v-for="i in Math.ceil(projects.length / 2)" :key=i>
      <div v-for="project in projects.slice((i-1) * 2,i*2)" class="col-5" :key=project>
        <div align="center">
